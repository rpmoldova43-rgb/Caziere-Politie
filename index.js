...
const GRADE_ROLE_MAP = {
  subcomisar: GRADE_SUBCOMISAR_ID,
  comisar: GRADE_COMISAR_ID,
  comisar_sef: GRADE_COMISAR_SEF_ID,
  sub_chestor: GRADE_SUB_CHESTOR_ID,
  chestor_general: GRADE_CHESTOR_GENERAL_ID,
};
...
function hasPoliceAccess(member) {
  ...
  return POLICE_ACCESS_ROLE_IDS.some((roleId) => member.roles.cache.has(roleId));
}
